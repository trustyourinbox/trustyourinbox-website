      ...
      <div className="container relative z-10 py-24 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-2 text-sm font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="gap-2 text-base h-12 px-8 bg-gradient-to-r from-primary to-accent-hover hover:opacity-90">
                Start Free Trial
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-20 -left-20 h-72 w-72 rounded-full bg-accent-hover/20 blur-3xl"></div>

            {/* Dashboard mockup - will be replaced with real screenshot */}
            <div className="relative">
              <div className="rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-background/50 to-background backdrop-blur-xl shadow-2xl overflow-hidden">
                <div className="aspect-[16/10] p-8 bg-gradient-to-br from-muted/30 via-background to-background">
                  {/* Window chrome */}
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-sm font-semibold text-muted-foreground">Analytics Dashboard</div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Chart area */}
                    <div className="rounded-xl bg-background/90 backdrop-blur-sm p-6 border border-border shadow-sm">
                      <div className="flex items-center justify-between mb-4">
                        <div className="text-sm font-medium text-foreground">Compliance Trends</div>
              ...
              {/* Floating badge */}
              <div className="absolute -right-4 -bottom-4 rounded-xl bg-background border-2 border-primary/20 shadow-xl p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary to-accent-hover flex items-center justify-center">
                    <Shield className="h-5 w-5 text-white" />
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-foreground">98% Protection</div>
