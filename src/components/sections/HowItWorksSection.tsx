...
const steps = [
  ...
  },
  {
    ...
    description: "We identify all legitimate email sources and help you configure SPF and DKIM for each one.",
  },
  {
    title: "Monitor in Reporting Mode",
    description: "Deploy DMARC in monitoring mode to gather data without affecting email delivery.",
  },
  {
    title: "Gradually Enforce Policies",
    description: "Based on reporting data, gradually increase enforcement levels until you reach full protection.",
  },
] 