...
const testimonials = [
  {
    ...
    initials: "JD",
    quote:
      "TrustYourInbox made implementing DMARC a breeze. We went from zero to enforcement in just two weeks.",
  },
  {
    name: "Alice Smith",
    ...
    initials: "AS",
    quote:
      "Managing multiple client domains is now effortless. The automation saves us hours every week.",
  },
  {
    name: "Robert Johnson",
    ...
    initials: "RJ",
    quote:
      "As a one-person IT team, I needed something simple. TrustYourInbox delivered exactly that.",
  },
];
