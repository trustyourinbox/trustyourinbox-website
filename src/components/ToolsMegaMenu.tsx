...
const coreTools = [
  ...
  },
  {
    ...
    icon: <FaChartLine className="h-5 w-5 text-green-600" />,
  },
  {
    ...
    icon: <FaSitemap className="h-5 w-5 text-purple-600" />,
  },
  {
  ...
  },
  {
    ...
    icon: <FaSearch className="h-5 w-5 text-yellow-600" />,
  },
];
