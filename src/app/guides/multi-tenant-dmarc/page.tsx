...
export const metadata = {
  title:
    "Multi-Tenant DMARC: Enterprise Deployment Guide for Large Organizations 2025",
  description:
    "Complete guide to deploying DMARC across large enterprises with multiple domains and business units. Learn phased rollout strategies, multi-domain management, stakeholder coordination, and how to reach p=reject in 1-2 weeks instead of 6+ months.",
  keywords: [
    "multi-tenant DMARC",
  ...
  openGraph: {
    title: "Multi-Tenant DMARC: Enterprise Deployment Guide 2025",
    description:
      "Deploy DMARC across large enterprises. Phased rollout, multi-domain management, stakeholder coordination.",
    type: "article",
  },
};

export default function MultiTenantDmarc() {
  return (
      ...
      <div className="border-border border-b">
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <h1 className="text-foreground mb-6 text-4xl font-bold tracking-tight sm:text-5xl">
            Multi-Tenant DMARC: Enterprise Deployment Guide
          </h1>
            ...
            <Link href="/guides/dmarc-policy-levels-explained">
              <Card className="hover:border-primary/50 h-full transition-colors">
                <div className="p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Understand p=none, p=quarantine, and p=reject
                  </p>
                </div>
              </Card>
            </Link>

            <Link href="/guides/subdomain-dmarc-policies">
              <Card className="hover:border-primary/50 h-full transition-colors">
                <div className="p-4">
                  <h3 className="text-foreground mb-2 font-semibold">
            ...
            <Link href="/guides/spf-10-dns-lookup-limit">
              <Card className="hover:border-primary/50 h-full transition-colors">
                <div className="p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Fix SPF PermError and lookup limits
                  </p>
                </div>
              </Card>
            </Link>
