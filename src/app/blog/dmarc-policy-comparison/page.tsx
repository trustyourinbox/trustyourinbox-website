...
export const metadata = {
  title:
    "DMARC Policy Comparison: p=none vs p=quarantine vs p=reject - Which to Use in 2025",
  description:
    "Complete comparison of DMARC policies (p=none, p=quarantine, p=reject). Learn when to use each policy, risks, benefits, deployment timeline, and how pct tags enable gradual rollout. Protect your domain from spoofing attacks.",
  keywords: [
  ...
  openGraph: {
    title:
      "DMARC Policy Comparison: p=none vs p=quarantine vs p=reject Guide 2025",
    description:
      "Compare DMARC policies. Learn when to use p=none, p=quarantine, or p=reject for maximum email security.",
    type: "article",
    publishedTime: "2025-01-19T00:00:00Z",
  },
};

export default function DmarcPolicyComparison() {
  return (
      ...
      <div className="border-border border-b">
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-6 flex flex-wrap items-center gap-3 text-sm">
            ...
            <span className="text-primary font-medium">Technical Guide</span>
          </div>
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            progress safely from monitoring to full protection in 1-2 weeks.
          </p>
        </div>
      </div>
